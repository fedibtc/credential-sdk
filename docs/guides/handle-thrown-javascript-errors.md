...
credential is not referenced by the authorization, the credential holder does
not match the authorization holder, or the authorization is outside its time
window.
